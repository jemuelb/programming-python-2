"""
Usage: "python cpall.py dirFom dirTo"
...
def copyfile(pathFrom, pathTo, maxfileload=maxfileload):
    ...
    uses binary file modes to supress Unicode and endline transform
    """
...
def copytree(dirFrom, dirTo, verbose=0):
    ...
    mayneed to do more file type checking on Unix; skip links, fifos, etc.
    """
    fcount = dcount = 0
