...
Automatically popus up an editor on each file containing string as it traverses;
...
class EditVisitor(SearchVisitor):
    ...
    """
    editor = 'atom'  # terminal command for atom editor

    def visitmatch(self, fpathname, text):
        """
        runs terminal command for text editor with filename
        """
