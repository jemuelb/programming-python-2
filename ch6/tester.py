"""
Test a directory of Python scripts, passing around command-line arguments,
...
This is a command-line scripts, using command-line arguments for
...
Suggest enhancement: could be extended to allow multiple sets
